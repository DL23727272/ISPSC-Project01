...
<html lang="en">
  <head>
    ...
    <title>Others - ISPSC Department of Psychology</title>
    <link
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              ...
              aria-current="page" href="others.php">Others</a>
            </li>
          </ul>
    ...
    <main class="container my-4">
      <h1>Others</h1>
      <p class="lead">
        Explore additional resources and miscellaneous information relevant to
        the Department of Psychology. This section includes updates, community
        news, and other academic resources that do not fit into the main
        categories.
      </p>
      <img
        src="placeholder.svg"
