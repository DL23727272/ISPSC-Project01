...
<html lang="en">
  <head>
    ...
    <title>Extension - ISPSC Department of Psychology</title>
    <link
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              ...
              aria-current="page" href="extension.php">Extension</a>
            </li>
            <li class="nav-item">
    ...
    <main class="container my-4">
      <h1>Extension Programs</h1>
      <p class="lead">
        Our extension programs are designed to bring psychological services and
        community outreach to local organizations. These initiatives aim to
        educate, empower, and improve the mental health of the broader community
        through workshops, seminars, and collaborative projects.
      </p>
      <ul>
        <li>Community Mental Health Workshops</li>
        <li>Outreach and Counseling Programs</li>
        <li>Partnerships with Local NGOs</li>
      </ul>
      <img
        src="placeholder.svg"
