...
<html lang="en">
  <head>
    ...
    <title>Research - ISPSC Department of Psychology</title>
    <link
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              ...
              aria-current="page" href="research.php">Research</a>
            </li>
            <li class="nav-item">
    ...
    <main class="container my-4">
      ...
      <p class="lead">
        Our department is at the forefront of psychological research. Explore
        our ongoing projects, published studies, and collaborative efforts that
        drive innovation in the field.
      </p>
      <ul>
        <li>Behavioral and Cognitive Research</li>
        <li>Clinical Psychology Studies</li>
        <li>Neuropsychological Investigations</li>
        <li>Social and Developmental Psychology Projects</li>
      </ul>
      <img
        src="placeholder.svg"
        alt="Research"
